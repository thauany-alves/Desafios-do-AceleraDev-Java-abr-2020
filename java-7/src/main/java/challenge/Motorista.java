...
public class Motorista {
    ...
    private void validacao(String nome,String habilitacao){
        if (nome ==null ||nome.isEmpty()) throw new NullPointerException("Informar nome motorista!");
        if (habilitacao==null||nome.isEmpty()) throw new NullPointerException("Informar habilitação!");
    }
    ...
    public static class MotoristaBuilder {
        ...
        public MotoristaBuilder withPontos(int pontos) {
            if (pontos<0) throw new IllegalArgumentException("Pontuacao inválida");
            this.pontos = pontos;
            return this;
        }
