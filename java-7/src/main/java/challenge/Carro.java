...
public class Carro {
    ...
    private void validacao(String placa, Cor cor){
        if (placa==null || placa.isEmpty()) throw new NullPointerException("Informar placa!");
        if (cor == null) throw  new NullPointerException("Informar cor válida");
    }
